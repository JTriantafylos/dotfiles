...
local theme = dofile(gfs.get_configuration_dir().."themes/default.lua")
local wallpaper_path = "/home/james/.dotfiles/wallpaper/wallpaper.jpg"
...
theme.border_width_floating  = dpi(3)
